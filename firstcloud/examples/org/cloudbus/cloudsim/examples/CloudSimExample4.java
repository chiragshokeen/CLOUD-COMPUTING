...
public class CloudSimExample4 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			long bw = 1000;
			int pesNumber = 1; //number of CPU's
			...
			vmid++;
			Vm vm2 = new Vm(vmid, brokerId, 300 , pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
		  //	vmid++ ; 
			//Vm vm3 = new Vm(vmid, brokerId, 300 , pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
